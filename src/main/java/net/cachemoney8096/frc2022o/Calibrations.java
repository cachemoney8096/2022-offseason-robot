...
public class Calibrations {
    public static final class Drivetrain {
        public static final SimpleMotorFeedforward DRIVE_FEEDFORWARD = new SimpleMotorFeedforward(0.0467, 3.3076,
                0.01897);
        public static final SimpleMotorFeedforward STEER_FEEDFORWARD = new SimpleMotorFeedforward(0.35233, 0.39185,
                0.0058658);
        ...
        public static final TrapezoidProfile.Constraints STEER_TRAPEZOID_CONSTRAINTS = new TrapezoidProfile.Constraints(
                20, 200);
        ...
        public static final ProfiledPIDController PATH_THETA_CONTROLLER = new ProfiledPIDController(
    ...
    /**
     * Hood setpoint table for shooter.
     * X = target linear distance from limelight
     * Y = Hood setpoint in degrees
     */
    public static final LinearInterpolatedTable2d HOOD_TABLE = new LinearInterpolatedTable2d()
            .withPair(0.0, 1.0)
            .withPair(1.0, 3.0)
            .withPair(0.5, 2.0)
            .withPair(2.0, 5.0);
    ...
    /**
     * Shooter speed setpoint table for shooter.
     * X = target linear distance from limelight
     * Y = Shooter speed in RPM
     */
    public static final LinearInterpolatedTable2d SHOOTER_TABLE = new LinearInterpolatedTable2d()
            .withPair(0.0, 1.0)
            .withPair(1.0, 3.0)
            .withPair(0.5, 2.0)
            .withPair(2.0, 5.0);
