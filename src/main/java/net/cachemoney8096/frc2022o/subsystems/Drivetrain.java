...
public class Drivetrain implements Subsystem {
    ...
    public final double MAX_VELOCITY_METERS_PER_SECOND = 6380.0 / 60.0 * driveReduction * wheelDiameterMeters * Math.PI;
    ...
    private final CoussensModuleConfiguration coussensModuleConfiguration = new CoussensModuleConfiguration();
    private final SwerveModule frontLeftModule = new SwerveModuleFactory<>(
            moduleConfiguration,
    ...
    private final SwerveModule frontRightModule = new SwerveModuleFactory<>(
            moduleConfiguration,
            new NeoDriveControllerFactoryBuilder()
                    .withVoltageCompensation(coussensModuleConfiguration.getNominalVoltage())
                    .withCurrentLimit(coussensModuleConfiguration.getDriveCurrentLimit())
    ...
    private final SwerveModule backLeftModule = new SwerveModuleFactory<>(
            moduleConfiguration,
            new NeoDriveControllerFactoryBuilder()
                    .withVoltageCompensation(coussensModuleConfiguration.getNominalVoltage())
                    .withCurrentLimit(coussensModuleConfiguration.getDriveCurrentLimit())
    ...
    private final SwerveModule backRightModule = new SwerveModuleFactory<>(
            moduleConfiguration,
            new NeoDriveControllerFactoryBuilder()
                    .withVoltageCompensation(coussensModuleConfiguration.getNominalVoltage())
                    .withCurrentLimit(coussensModuleConfiguration.getDriveCurrentLimit())
    ...
    public Rotation2d getGyroscopeRotation() {
        return Rotation2d.fromDegrees(pigeonImu.getFusedHeading() + Units.radiansToDegrees(gyroOffsetRad));
    }
    ...
    public void drive(double xCommand, double yCommand, double rotationCommand, boolean fieldRelative) {
        ...
        ChassisSpeeds chassisSpeeds = fieldRelative
                ? ChassisSpeeds.fromFieldRelativeSpeeds(xVelocityMetersPerSec, yVelocityMetersPerSec,
                        rotVelocityRadPerSec, getGyroscopeRotation())
    ...
    private void setModuleStates(SwerveModuleStates states) {
        ...
        frontRightModule.set(states.frontRightSwerveModuleState.speedMetersPerSecond
                / MAX_VELOCITY_METERS_PER_SECOND
                * coussensModuleConfiguration.getNominalVoltage(),
                states.frontRightSwerveModuleState.angle.getRadians());
        backLeftModule.set(states.backLeftSwerveModuleState.speedMetersPerSecond
                / MAX_VELOCITY_METERS_PER_SECOND
                * coussensModuleConfiguration.getNominalVoltage(),
                states.backLeftSwerveModuleState.angle.getRadians());
        backRightModule.set(states.backRightSwerveModuleState.speedMetersPerSecond
                / MAX_VELOCITY_METERS_PER_SECOND
                * coussensModuleConfiguration.getNominalVoltage(),
